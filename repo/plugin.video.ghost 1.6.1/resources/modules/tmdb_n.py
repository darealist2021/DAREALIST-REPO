...
class tmdb:
    ...
    def add_dir(self,season=0):
        ...
        if not self.simple_data:
            ...
            listitem.setArt({'fanart':'https://thechains24.com/PornKing/fanart.jpg','icon':'https://thechains24.com/PornKing/next.png','thumb':'https://thechains24.com/PornKing/next.png'})
